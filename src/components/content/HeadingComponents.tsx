...
export function H3({ children, className, style }: HeadingProps) {
  return (
    <h3 className={cn('text-2xl font-semibold mb-2', className)} style={style}>
      {children}
    </h3>
  )
}
...
export function H5({ children, className }: HeadingProps) {
  return (
    <h5 className={cn('text-lg font-medium mb-2', className)}>
      {children}
    </h5>
  )
}
...
export function H6({ children, className }: HeadingProps) {
  return (
    <h6 className={cn('text-base font-medium mb-2', className)}>
      {children}
    </h6>
  )
}
